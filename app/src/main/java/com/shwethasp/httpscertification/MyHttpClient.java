...
/**
 * Created by HemanthYa on 07-07-2016.
 */
public class MyHttpClient extends DefaultHttpClient {
    ...
    private SSLSocketFactory newSslSocketFactory() {
        try {
            ...
            InputStream in = MyHttpClient.context.getResources().openRawResource(R.raw.httpscertification); //name of your keystore file here
            try {
                // Initialize the keystore with the provided trusted certificates
                // Provide the password of the keystore
                trusted.load(in, "certificate".toCharArray());
            } finally {
                in.close();
            }
